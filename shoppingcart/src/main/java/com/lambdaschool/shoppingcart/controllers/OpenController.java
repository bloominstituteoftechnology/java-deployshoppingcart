...
public class OpenController
{
        ...
        URISyntaxException
    {
        ...
        newuser.setComments(newminuser.getComments());
        ...
        // if you give heroku a port, it stalls (httpServletRequest) -- fix by ternary statement
        RestTemplate restTemplate = new RestTemplate();
        String requestURI = "http://" + httpServletRequest.getServerName() +
            (httpServletRequest.getServerName()
                .equalsIgnoreCase("localhost") ? ":" + httpServletRequest.getLocalPort() : "") +
            "/login";
        ...
        headers.setBasicAuth(System.getenv("lambda-id"),
